...
(function ($) {
    ...
    $("#select-search3,.kb__select").select2({
        placeholder: "Search",
        dropdownCssClass: "category-member",
        allowClear: true,
    });
    ...
    function staff_wizard() {
        if (
            ...
            if (
                ...
                $("#3").addClass("current");
                $("#2-span").html("");
                $("#2-span").addClass("las la-check");
                $("#details_form").hide();
                $("#specialization_form").show();

                if (
                    $("#title").val() == "" ||
                    $("#specialty").val() == "" ||
                    $("#nurse_license_number").val() == ""
                ) {
                } else {
    ...
    $(document).ready(function () {
        $("#save_address_btn").click(function (e) {
            ...
            if (
                ...
                $("#area").val() == "" ||
                $("#town").val() == "" ||
                $("#county").find(":selected").val() == undefined
            ) {
            } else {
                var data = {
                    user_id: $("#user_id").val(),
        ...
        $("#save_details_btn").click(function (e) {
            e.preventDefault();
            if (
                $("#id_number").val() == "" ||
                $("#date_of_birth").val() == "" ||
                $("#gender :selected").val() == undefined
            ) {
            } else {
                var data = {
                    user_id: $("#user_id").val(),
        ...
        $("#save_specialization_btn").click(function (e) {
            e.preventDefault();
            if (
                $("#title").val() == "" ||
                $("#specialty").val() == "" ||
